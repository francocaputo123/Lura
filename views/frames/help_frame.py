...
data_help = DATA_HELP = [
    {
        ...
        "description" : "Para empezar la aplicación, es tan sensillo como crear(o importar) un mazo de tarjetas. Luego, puedes añadir tarjetas a ese mazo y empezar a estudiar. Durante el estudio, se te presentarán las tarjetas y, dependiendo de cuanto te costó responderla, deberás seleccionar una opción: Otra vez, Difícil, Bien o Fácil."
    },
    {
                        ...
                        "Fácil: Tardará en volver a aparecer(aumentará la dificultad)."},
    {
        ...
        "description" : "La aplicación almacena todos los datos localmente en tu dispositivo, sin enviar información a servidores externos. Esto garantiza que tus tarjetas y progreso de estudio permanezcan privados y seguros."
    },
    {
        "title" : "Reportar Errores y Sugerencias",
        "description" : "Si encuestras errores en la aplicación o tienes sugerencias, puedes reportarlo en el repositorio de GitHub: https://github.com/francocaputo123/Lura/issues"
    }
]
...
class AccordionItem(wx.Panel):
    def __init__(self, parent, title_text, description_text):
        ...
        self.description.SetForegroundColour(theme.PALET["FG_DARK"]) 
        self.description.SetBackgroundColour(theme.PALET["BG_CARD_DESCRIPTION"]) 
        ...
        #Ensambla todo 
        self.main_sizer.Add(self.title_sizer, 0, wx.EXPAND | wx.TOP, 5)
        self.main_sizer.Add(self.description, 0, wx.EXPAND | wx.LEFT, 20) 
...
class HelpFrame(wx.Panel):
    def __init__(self, parent):
        ...
        title = wx.StaticText(panel_content, label="\n Ayuda\n")
        ...
        item5 = AccordionItem(panel_content, data_help[4]["title"], data_help[4]["description"])
        ...
        panel_content_sizer.Add(item5, 0, wx.EXPAND | wx.ALL, 5)
